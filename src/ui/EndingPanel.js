...
const TRUTH = [
  ['배후', '김상무', '하반기 예산 재배정을 일방적으로 지시했다. AI 파트는 공문 없이 구두로 처리하게 했다.'],
  ['실행', '박피엠', '지시를 이행해 사전 협의 없이 강사료를 깎고, 교육 이틀 전에 실습시간 단축을 통보했다.'],
  ['결과', '조강사 / 정강사', '조강사는 신규 실습을 포기하고 예전 자료를 재사용했고, 정강사는 사업부장급에 맞지 않는 범용 기술 템플릿을 급조했다.']
];
...
export function openEnding({ onRestart }) {
  ...
  const body = solved
    ? [
        ...
        h('p', {}, '만족도 급락은 한 사람의 잘못이 아니었다. 위에서 내려온 예산 지시가 협의 없는 일정 변경으로, 다시 준비 부족과 자료 재사용으로 이어졌다. 이과장의 수치 부풀리기와 최본부장의 개인 불만은 표면의 혼선이었다.')
      ]
    : [
